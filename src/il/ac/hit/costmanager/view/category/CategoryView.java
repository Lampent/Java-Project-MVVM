...
public class CategoryView extends javax.swing.JFrame implements IView {
    ...
    // this button click insert category in database
    ...
    // this function is get data from database and set in table
    /**
     *
     */
    public void setTableData() {
        ...
        try {
            ...
            for (int i = 0; i < catModel.size(); i++) {
                data[0] = catModel.get(i).getCatId();
                data[1] = catModel.get(i).getCategoryName();
